...
writeMatrix(fileName=\"StruRenovated.mat\",matrixName=\"A\",matrix=re.A);<br/>
writeMatrix(fileName=\"StruRenovated.mat\",matrixName=\"B\",matrix=re.B, append=true);<br/>
writeMatrix(fileName=\"StruRenovated.mat\",matrixName=\"C\",matrix=re.C, append=true);<br/>
writeMatrix(fileName=\"StruRenovated.mat\",matrixName=\"D\",matrix=re.D, append=true);<br/>
